...
class Restaurant(BaseModel):
    ...
    restaurant_category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='restaurants',)
...
class TableQR(BaseModel):
    ...
    qrlink = models.ImageField(upload_to="tableqr/%Y/%m/%d/",null=True, blank=True,)
...
# check once my by noob
class MenuTypes(BaseModel):
    name = models.CharField(max_length=20)
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE, related_name='menutypes')
    class Meta:
...
class UnitCategory(models.Model):
    ...
    name = models.CharField(max_length=20, unique=True, help_text="Name of the unit category")
    abbreviation = models.CharField(max_length=5, choices=UNIT_CHOICES, help_text="Unit abbreviation")
...
class Inventory(BaseModel):
    ...
    unit_category = models.ForeignKey(UnitCategory, on_delete=models.CASCADE, related_name='unit_categories')
